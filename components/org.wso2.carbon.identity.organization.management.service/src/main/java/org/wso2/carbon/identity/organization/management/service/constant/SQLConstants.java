...
public class SQLConstants {
    ...
    public static final String GET_ORGANIZATION_BY_ID = "SELECT UM_ORG.UM_ID, UM_ORG_NAME, UM_ORG_DESCRIPTION, " +
            "UM_CREATED_TIME, UM_LAST_MODIFIED, UM_STATUS, UM_PARENT_ID, UM_ORG_TYPE, UM_TENANT_ID, UM_ATTRIBUTE_KEY, "
            + "UM_ATTRIBUTE_VALUE FROM UM_ORG LEFT OUTER JOIN UM_ORG_ATTRIBUTE ON " +
            "UM_ORG.UM_ID = UM_ORG_ATTRIBUTE.UM_ORG_ID WHERE " + "UM_ORG.UM_ID = :" +
            SQLPlaceholders.DB_SCHEMA_COLUMN_NAME_ID + ";";
